...
-- Prerequisites: public.today_priorities_company_view, public.whats_working_today, public.opportunities_today,
-- public.watchlist_today, public.company_data_confidence, public.company_status_current (orgs union).
-- For company_status_current + dashboard together, prefer fix-company-status-current-and-today-dashboard.sql
