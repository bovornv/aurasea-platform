...
--
-- branch_daily_metrics (canonical read model): company fallback + performance drivers read this object.
-- Legacy recreate-daily-metrics-view.sql defined public.daily_metrics; prefer branch_daily_metrics and drop
-- daily_metrics after rewiring (see drop-public-daily-metrics.sql).
...
--
-- 4d) whats_working_today — rebuild-alerts-enriched-engine.sql STEP 6d; see add-whats-working-today-view.sql
