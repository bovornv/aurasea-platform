...
export const SELECT_WHATS_WORKING_TODAY =
  'organization_id,branch_id,branch_name,metric_date,title,description,sort_score,whats_working_text';
...
export const SELECT_WHATS_WORKING_TODAY_BRANCH =
  'branch_name,metric_date,title,description,sort_score,whats_working_text';
