...
export function CompanyBusinessTrendSummary({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
      <p style={{ margin: 0, fontSize: '14px', color: '#6b7280', lineHeight: 1.5 }}>
        {th
          ? 'ยังไม่พบข้อมูลรายได้รายวันใน today_summary_clean สำหรับสาขาในกลุ่ม — ตรวจสอบการบันทึกเมตริกรายวัน'
          : 'No daily revenue in today_summary_clean for your branches yet — check daily metrics are being recorded.'}
      </p>
      {linkBtn}
    </div>
  );
